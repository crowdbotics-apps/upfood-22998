"""upfood_22998 URL Configuration
...
admin.site.site_header = "UpFood"
admin.site.site_title = "UpFood Admin Portal"
admin.site.index_title = "UpFood Admin"

# swagger
api_info = openapi.Info(
    title="UpFood API",
    default_version="v1",
    description="API documentation for UpFood App",
)
